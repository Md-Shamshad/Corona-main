 ...
 * 
 */
public class ValidFuturePricingPropagation implements IBeanPropagation {
	...
	public CTODaxDataBeanGeneral processBeans(CTODaxDataBeanGeneral cto) {
		...
		try {
			...
			if (events != null && events.length < 1) {
				...
				throw new Exception("No event to process in valid future price");
			...
			CoronaErrorHandler.logError(this.getClass(),
					...
					"Error while processing for valid future price", false, e,
					true);
