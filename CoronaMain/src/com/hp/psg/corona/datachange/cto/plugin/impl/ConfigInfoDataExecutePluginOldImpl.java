 ...
 * 
 */
public class ConfigInfoDataExecutePluginOldImpl implements IBusinessProcessPlugin {
	...
	public static void main(String args[]) {
		...
		ConfigInfoDataExecutePluginOldImpl obj = new ConfigInfoDataExecutePluginOldImpl();
