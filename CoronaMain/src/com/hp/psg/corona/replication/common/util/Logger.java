 ...
 */
public class Logger {
    public static final String LOGGER_CFG = "logger.cfg";
    ...
    */
     private static void init() {
         ...
         try {
        	 InputStream configStream = Logger.class.getClassLoader().getResourceAsStream(LOGGER_CFG);
             if (configStream == null){
            	 configStream = new FileInputStream(LOGGER_CFG); //use FileInputStream instead of getClass CAB                 
             }
             if (configStream != null) {
